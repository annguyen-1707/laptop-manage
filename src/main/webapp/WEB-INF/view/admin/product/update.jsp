                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <form:select class=" form-select" path="factory"> >
                                                <form:option selected="${product.factory eq 'Apple'}" value="Apple">
                                                    Apple</form:option>
                                                <form:option selected="${product.factory eq 'Asus'}" value="Asus">Asus
                                                </form:option>
                                                <form:option selected="${product.factory eq 'Lenovo'}" value="Lenovo">
                                                    Lenovo</form:option>
                                                <form:option selected="${product.factory eq 'Dell'}" value="Dell">Dell
                                                </form:option>
                                                <form:option selected="${product.factory eq 'LG'}" value="LG">LG
                                                </form:option>
                                                <form:option selected="${product.factory eq 'Acer'}" value="Acer">Acer
                                                </form:option>
                                            </form:select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <form:select class=" form-select" path="target"> >
                                                <form:option selected="${product.target eq 'Gaming'}" value="Gaming">
                                                    Gaming</form:option>
                                                <form:option selected="${product.target eq 'Sinh viên văn phòng'}"
                                                    value="Sinh viên văn phòng">Sinh viên văn phòng
                                                </form:option>
                                                <form:option selected="${product.target eq 'Thiết kế đồ họa'}"
                                                    value="Thiết kế đồ họa">Thiết kế đồ họa </form:option>
                                                <form:option selected="${product.target eq 'Mỏng nhẹ'}"
                                                    value="Mỏng nhẹ">Mỏng nhẹ </form:option>
                                                <form:option selected="${product.target eq 'Doanh nhân'}"
