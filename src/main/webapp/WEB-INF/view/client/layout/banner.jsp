                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            <img src="client/img/hero-img-apple.webp" class="img-fluid w-100 h-100 bg-secondary rounded"
                                alt="First slide">
                            <a href="#tab-apple" class="btn px-4 py-2 text-white rounded">Apple</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="client/img/hero-img-asus.webp" class="img-fluid w-100 h-100 bg-secondary rounded"
                                alt="Second slide">
                            <a href="#" class="btn px-4 py-2 text-white rounded">Asus</a>
                        </div>
                        <div class="carousel-item rounded">
                            <img src="client/img/hero-img-dell.png" class="img-fluid w-100 h-100 bg-secondary rounded"
                                alt="Second slide">
